...
const SignUp = ({ setSignUp }) => {
    ...
    const [doctorSignUp, { data: dData, isSuccess: dIsSuccess, isError: dIsError, error: dError }] = useDoctorSignUpMutation();
    const [patientSignUp, { data: pData, isSuccess: pIsSuccess, isError: pIsError, error: pError }] = usePatientSignUpMutation();
    ...
    const handleSignUpSuccess = () => {
        setLoading(false);
        setUser(formField); // Reset the form to initial state
    };
    ...
    }, [dIsError, dError, pError, pIsError, pIsSuccess, dIsSuccess]);
    ...
    const handleUserTypeChange = (e) => {
        ...
        if (e.target.value !== 'doctor') {
            setUser((prevUser) => ({ ...prevUser, pdfFiles: '' }));
        }
    };

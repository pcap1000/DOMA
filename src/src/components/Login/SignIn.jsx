...
const SignIn = ({ handleResponse }) => {
    ...
    const [userLogin, { isError, isLoading, isSuccess, error, data: loginData }] = useUserLoginMutation();
    ...
    }, [isError, error, isSuccess, loginData, navigate]);
        ...
        <>
            {showForgotPassword ? (
                <form className="sign-in-form" onSubmit={onHandleForgotPassword}>
                    ...
                    <div onClick={handleShowForgotPassword} className='text-bold' style={{ cursor: "pointer", color: '#3b74d1' }}>Still Remember Password ?</div>
